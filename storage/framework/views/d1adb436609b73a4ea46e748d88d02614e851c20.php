...
<body>
    ...
    <img class="aboutusheadpic" src="<?php echo e(asset('./images/aboutushead.jpg')); ?>">

    <div class="container-fluid" id="header">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset('./images/G5-Logo-B-White-on-Black-Border-V1.png')); ?>" alt="Logo" width="200" height="100"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-5">
                                                <form>
                                                    ...
                                                    <p>Don't have an account? <a href="<?php echo e(url('/signup')); ?>"
                                            ...
                                            <div class="modal-footer">
                                                <h5><a href="<?php echo e(url('/underconstruction')); ?>"
            ...
            <div class="article">
                <p>Josh Pamara Rent-A-Car Services was a family business initially registered as a single proprietorship
                    ...
                    rental industry. We strive to be on top and prove that <strong>wherever it is, we know how to get
                        you there
                        safely.</strong></p>
                <img src="<?php echo e(asset('./images/aboutus1.JPG')); ?>" class="aboutus1">
            </div>
            <div class="article2">
...
</html><?php /**PATH C:\Users\Sharynel\Desktop\capstone\programmerist\resources\views//aboutus.blade.php ENDPATH**/ ?>